...
/* --------------------- fixed_clock ------------ */
static inline unsigned long __metal_driver_fixed_clock_rate( )
{
...
static inline unsigned long __metal_driver_fixed_factor_clock_mult( )
{
		return METAL_FIXED_FACTOR_CLOCK__CLOCK_MULT;
}

static inline unsigned long __metal_driver_fixed_factor_clock_div( )
{
