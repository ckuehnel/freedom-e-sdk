...
/* --------------------- fixed_clock ------------ */
extern inline unsigned long __metal_driver_fixed_clock_rate( );


/* --------------------- fixed_factor_clock ------------ */
extern inline struct metal_clock * __metal_driver_fixed_factor_clock_parent(struct metal_clock *clock);
extern inline unsigned long __metal_driver_fixed_factor_clock_mult( );
extern inline unsigned long __metal_driver_fixed_factor_clock_div( );
